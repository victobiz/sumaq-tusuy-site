...
export const metadata: Metadata = {
  ...
  description:
    "Book Sumaj Tusuy for your wedding, corporate event, festival, or private celebration. Experience authentic Peruvian dance performances.",
}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-primary-foreground/80">
                      ...
                      <br />
                      <span className="text-sm">Serving D.C., Maryland, and Virginia</span>
                    </p>
                  </div>
                </div>
              </div>
